    ...
    return '<article class="feed-module__Sej6XW__post" data-post-id="'+p.id+'">' +
      ...
      '<div class="feed-module__Sej6XW__postActions">' +
        '<button class="feed-module__Sej6XW__actionBtn ">' +
          '<svg width="22" height="22" viewBox="0 0 24 24" fill="'+(p.liked?'#ff4757':'none')+'" stroke="'+(p.liked?'#ff4757':'currentColor')+'" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>' +
